...
namespace GuildManager.Core.Models
{
    ...
    /// 入手経路はpost-MVP（→ §11）。Price・EffectValueは docs/04_バランス表/equipment.csv
    /// 由来（→ EquipmentBalance、項目58フォローアップ）。
    /// </summary>
    public static class ItemCatalog
    {
        ...
        public static readonly Item IronSword = new Item
        {
            ...
            EffectType = EquipmentEffectType.PersonalCpBonus, EffectValue = EquipmentBalance.IronSwordEffectValue, Price = EquipmentBalance.IronSwordPrice,
        ...
        public static readonly Item LeatherArmor = new Item
        {
            ...
            EffectType = EquipmentEffectType.MaxHpBonus, EffectValue = EquipmentBalance.LeatherArmorEffectValue, Price = EquipmentBalance.LeatherArmorPrice,
        ...
        public static readonly Item PowerRing = new Item
        {
            ...
            EffectType = EquipmentEffectType.PersonalCpBonus, EffectValue = EquipmentBalance.PowerRingEffectValue, Price = EquipmentBalance.PowerRingPrice,
        ...
        public static readonly Item LifeAmulet = new Item
        {
            ...
            EffectType = EquipmentEffectType.MaxHpBonus, EffectValue = EquipmentBalance.LifeAmuletEffectValue, Price = EquipmentBalance.LifeAmuletPrice,
        ...
        public static readonly Item QuickBrooch = new Item
        {
            ...
            EffectType = EquipmentEffectType.PersonalCpBonus, EffectValue = EquipmentBalance.QuickBroochEffectValue, Price = EquipmentBalance.QuickBroochPrice,
        ...
        public static readonly Item GuardCharm = new Item
        {
            ...
            EffectType = EquipmentEffectType.MaxHpBonus, EffectValue = EquipmentBalance.GuardCharmEffectValue, Price = EquipmentBalance.GuardCharmPrice,
        };
