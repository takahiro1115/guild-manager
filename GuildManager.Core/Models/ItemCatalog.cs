...
namespace GuildManager.Core.Models
{
    ...
    /// 入手経路はpost-MVP（→ §11）。Price・EffectValue・能力値補正（StatBonuses）は
    ...
    public static class ItemCatalog
    {
        ...
        private static Item Define(Item item)
        {
            ...
            item.EffectValue = stats.EffectValue;
            item.StatBonuses = stats.StatBonuses;
            return item;
        }

        // ---- 武器（Weapon）：個人CPへの固定加算＋能力値補正 ----
        ...
        public static readonly Item IronSword = Define(new Item
        {
            ...
            EffectType = EquipmentEffectType.PersonalCpBonus,
        ...
        public static readonly Item LeatherArmor = Define(new Item
        {
            ...
            EffectType = EquipmentEffectType.MaxHpBonus,
