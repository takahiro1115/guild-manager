...
namespace GuildManager.Core.Balance
{
    ...
    public static class GrowthBalance
    {
        ...
        // 前衛(Warrior)はSTR/AGI/END寄り、斥候(Ranger)はAGI/SCT寄り、魔導士(Mage)はMAG寄り、
        // 神官(Cleric)はMAG/LDR寄り。
        private static readonly Dictionary<JobClass, (string Stat, int Weight)[]> JobStatWeights = new()
        {
            [JobClass.Warrior] = new[] { ("STR", 3), ("AGI", 1), ("END", 3), ("MAG", 0), ("SCT", 1), ("LDR", 1) },
            [JobClass.Ranger] = new[] { ("STR", 1), ("AGI", 3), ("END", 1), ("MAG", 0), ("SCT", 3), ("LDR", 1) },
            [JobClass.Mage] = new[] { ("STR", 0), ("AGI", 1), ("END", 1), ("MAG", 3), ("SCT", 1), ("LDR", 1) },
            [JobClass.Cleric] = new[] { ("STR", 0), ("AGI", 1), ("END", 1), ("MAG", 2), ("SCT", 1), ("LDR", 2) },
        };
